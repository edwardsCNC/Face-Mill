...
Here is a video example of a CNC mill running a program generated by Face-Mill. This example uses a shallow depth of cut in order to make a fine finished surface which a flat workholding table can be mounted on. (Warning: this video is slow and boring! You will likely get the idea from just watching a little segment of it.)

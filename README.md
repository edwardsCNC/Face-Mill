...
Here is an example of a console session for generating the CNC program. You can preview the toolpaths by copying and pasting the CNC program into [G-Code Q'n'dirty toolpath simulator](https://nraynaud.github.io/webgcode/).
